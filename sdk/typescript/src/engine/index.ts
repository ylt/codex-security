...
export function createEngine(type: EngineType, config: EngineConfig, env: Record<string, string | undefined>): ScanEngine {
  return type === "claude" ? new ClaudeEngine(config, env) : new CodexEngine(config, env);
}
